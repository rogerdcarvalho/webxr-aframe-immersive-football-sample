...
AFRAME.registerComponent('raycaster-extras', {
    ...
    tick: function () 
    {
        ...
        {
            window.debug = "An element has focus"
        ...
        {
            window.debug = "An element lost focus"
            this.focusedElement = null;
            this.intersectionPoint = null;
        }
             ...
             this.focusedElement != null && this.grabbedElement == null )
        {
            if ( this.focusedElement.components["raycaster-target"] &&
                 this.focusedElement.components["raycaster-target"].data.canClick )
            {
                // click and emit an event
                this.focusedElement.click();
                this.focusedElement.emit( "raycaster-clicked", {el: this.focusedElement} );
            }
             ...
             this.focusedElement != null && this.grabbedElement == null )
        {
                 ...
                 this.focusedElement.components["raycaster-target"].data.canGrab )
            {
                ...
                const childList = Array.from(this.focusedElement.children);
                childList.forEach(function(child){
                    child.setAttribute("material", "emissive", "#000000"); 
                });
        ...
        if ( this.grabbedElement != null )
        {
            ...
            if ( this.controllerData.rightGrip.released )
            {
                ...
                if ( this.grabbedElement.components["raycaster-target"].data.glowOnHover ) {
                    ...
                    const childList = Array.from(this.grabbedElement.children);
                    childList.forEach(function(child){
                        child.setAttribute("material", "emissive", "#444444"); 
                    });
                }
...
AFRAME.registerComponent('raycaster-target', {
    ...
    init: function () 
    {
        ...
        window.debug = "Initialzing raycaster target"
            ...
            { 
                ...
                if (self.data.glowOnHover) {
                    try {
                        ...
                        const childList = Array.from(self.el.children);
                        childList.forEach(function(child){
                            child.setAttribute("material", "emissive", "#444444"); 
                        });
                    }
                    catch (e) {
                        window.debug = e.message
                    }
